...
The host agent loads Skill `security-harness` (MCP tools `harness_plan` / `harness_run`). That Skill forbids running the vendored scripts. Original `SKILL.md` files stay as the upstream source of truth.
